using ArdalisCleanArch.Core.Interfaces;
using ArdalisCleanArch.Core.Services;
using ArdalisCleanArch.Infrastructure.Data;
using ArdalisCleanArch.Infrastructure.Data.Queries;
using ArdalisCleanArch.UseCases.Contributors.List;

namespace ArdalisCleanArch.Infrastructure;
