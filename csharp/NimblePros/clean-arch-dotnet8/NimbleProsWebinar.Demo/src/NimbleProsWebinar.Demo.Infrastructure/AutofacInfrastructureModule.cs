...
using NimbleProsWebinar.Demo.Infrastructure.Data;
using NimbleProsWebinar.Demo.Infrastructure.Data.Queries;
using NimbleProsWebinar.Demo.Infrastructure.Email;
using NimbleProsWebinar.Demo.UseCases.Contributors.Create;
using NimbleProsWebinar.Demo.UseCases.Contributors.List;
using MediatR;
using MediatR.Pipeline;
using Module = Autofac.Module;

namespace NimbleProsWebinar.Demo.Infrastructure;
