...
using NimblePros.WebinarDemo.Core.ProjectAggregate;
using NimblePros.WebinarDemo.Core.Services;
using NimblePros.WebinarDemo.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace NimblePros.WebinarDemo.UnitTests.Core.Services
{
