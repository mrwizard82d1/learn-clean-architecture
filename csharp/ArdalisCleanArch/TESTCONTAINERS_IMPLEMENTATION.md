...
**Updated `tests\ArdalisCleanArch.FunctionalTests\ArdalisCleanArch.FunctionalTests.csproj`:**
- Removed: `Microsoft.EntityFrameworkCore.InMemory`
- Added: `Testcontainers` and `Testcontainers.MsSql`

### 2. CustomWebApplicationFactory

**File:** `tests\ArdalisCleanArch.FunctionalTests\CustomWebApplicationFactory.cs`
...
```bash
dotnet test tests\ArdalisCleanArch.FunctionalTests\ArdalisCleanArch.FunctionalTests.csproj
```
