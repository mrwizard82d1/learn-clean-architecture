using TaylorCaSlnDefault.Application.Common.Models;
using TaylorCaSlnDefault.Application.TodoItems.Commands.CreateTodoItem;
using TaylorCaSlnDefault.Application.TodoItems.Commands.DeleteTodoItem;
using TaylorCaSlnDefault.Application.TodoItems.Commands.UpdateTodoItem;
using TaylorCaSlnDefault.Application.TodoItems.Commands.UpdateTodoItemDetail;
using TaylorCaSlnDefault.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace TaylorCaSlnDefault.Web.Endpoints;
