...
1. Set `ArdalisCleanArch.AspireHost` as the startup project
...
```bash
dotnet ef migrations add MigrationName -c AppDbContext -p ../ArdalisCleanArch.Infrastructure/ArdalisCleanArch.Infrastructure.csproj -s ArdalisCleanArch.Web.csproj -o Data/Migrations
```

To update the database:
```bash
dotnet ef database update -c AppDbContext -p ../ArdalisCleanArch.Infrastructure/ArdalisCleanArch.Infrastructure.csproj -s ArdalisCleanArch.Web.csproj
```
