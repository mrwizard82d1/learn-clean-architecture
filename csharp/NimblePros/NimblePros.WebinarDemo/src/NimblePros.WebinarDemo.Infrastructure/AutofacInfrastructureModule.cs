...
using NimblePros.WebinarDemo.Infrastructure.Data;
using NimblePros.WebinarDemo.Infrastructure.Data.Queries;
using NimblePros.WebinarDemo.Infrastructure.Email;
using NimblePros.WebinarDemo.UseCases.Contributors.Create;
using NimblePros.WebinarDemo.UseCases.Contributors.List;
using MediatR;
using MediatR.Pipeline;
using Module = Autofac.Module;

namespace NimblePros.WebinarDemo.Infrastructure;
